...
/**
 * <code>MainLayout</code> je layout manager napravljen za potrebe Corala. Ovo
 * je u stvari malo modificirani Javin <code>BorderLayout</code>.
 * Modifikacije su napravljene tako da središnja komponenta uvijek ima fiksnu
 * širinu, a lijeva i desna jednako dijele preostali prostor.
 * 
 */
public class MainLayout implements LayoutManager2, java.io.Serializable {
	/**
	 ...
	 *            the vertical gap.
	 */
	public MainLayout(int hgap, int vgap) {
		this.hgap = hgap;
		this.vgap = vgap;
	}
